...
function StoreTodo(props) {
    ...
    const [isMailOptionsEnabled, setIsMailOptionsEnabled] = useState(false);

    const handleEmailClicked = () => {
        setIsEmailClicked(true);
    }

    const handleMailCheckbox = (event) => {
        setIsMailOptionsEnabled(event.target.checked);
    }
    ...
    return(
        ...
        <Modal.Body>
           ...
           <Form.Check 
             type="checkbox"
             label="Enable mail options"
             name="check"
             id="custom-check"
             checked={isMailOptionsEnabled}
             onChange={handleMailCheckbox}
           />
           {isMailOptionsEnabled ? 
           <>
           <Form.Label>Name of File</Form.Label>
           <Form.Control type="text" placeholder="Please enter the name" value={fileName} onChange={handleName}></Form.Control>    
           <Form.Label>Email Id</Form.Label>
           <Form.Control type="text" placeholder="Please enter the mail-Id" value={emailId} onChange={handleMail}></Form.Control>  
           <div className="btns-grp-store-todo">
